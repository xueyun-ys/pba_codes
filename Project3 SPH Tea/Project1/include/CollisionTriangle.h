...
namespace pba {
	...
	public:
		...
		CollisionTriangleRaw(const Vector& p0, const Vector& p1, const Vector& p2)//construction method /hanshu
		{
			P0 = p0;
			P1 = p1;
			P2 = p2;
			...
			decayrate = 0.5;//not float decayrate
			visible = true;//totally visible or not
			//visible = false;
